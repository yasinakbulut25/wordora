    ...
    <div className="relative">
      ...
      {selected && (
        <Button
          ...
          disabled={!selected}
          className="sticky bottom-0 bg-indigo-600 w-full text-white font-bold mt-6 rounded-full px-2 py-6 hover:bg-indigo-500 transition-all active:scale-90 z-20"
        >
          {t("CONTINUE")}
